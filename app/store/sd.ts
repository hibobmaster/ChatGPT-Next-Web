  ...
  (set, _get) => {
    ...
    const methods = {
      ...
      stabilityRequestCall(data: any) {
        const accessStore = useAccessStore.getState() as any;
        const prefix: string = ApiPath.Stability as string;
        let bearerToken = getBearerToken(accessStore.stabilityApiKey);
